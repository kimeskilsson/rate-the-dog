...
import datasheet_dogPic_row0_message from './images/datasheet_dogPic_row0_message.png';

export default class DataSheet_dogPic extends DataSheetBase {
  ...
  makeDefaultItems() {
    ...
    item['status'] = "success";
    item['message'] = datasheet_dogPic_row0_message;
    item.key = key++;
  }
